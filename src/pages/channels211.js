...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"channels211"} />
		<Helmet>
			<title>
				Quarkly export
			</title>
		...
		<Box display="flex" width="100vw" height="100vh" min-height="100vh">
			<Box
				color="white"
				display="flex"
				width="350px"
			...
			>
				...
				>
					...
					<Box display="flex" align-self="flex-start" margin-bottom="30px">
						<Text font="500 16px &quot;Montserrat Alternates&quot;, sans-serif" display="flex" margin="0 0px 0 0px">
							Слушают Вас:
						</Text>
						<Text color="#2C94FF" margin="0px 5px 0px 5px" font="500 16px &quot;Montserrat Alternates&quot;, sans-serif" display="flex">
							126{" "}
							<Icon
								category="md"
								icon={MdPeople}
					...
					<Box position="absolute" bottom="50px">
						...
						<Box display="flex" justify-content="center" align-items="center">
							...
							<Box
								...
								align-items="center"
							>
								<Icon color="rgba(255, 0, 4, 0.76)" category="md" icon={MdExitToApp} />
							</Box>
						</Box>
					</Box>
				</Box>
			...
			>
				...
				>
					<Box display="flex">
						<Text color="#2C94FF" margin="16px 10px 16px 0px" font="500 16px sans-serif">
							Вы:
						</Text>
						<Text>
							Всем привет! Задавайте вопросы в чат! Я обязательно их прочту и отвечу.
						</Text>
					</Box>
					<Box
						position="absolute"
						...
						justify-content="space-between"
					>
						<Input border-radius="0 0 0 20px" width="100%" placeholder="Введите свое сообщение" height="40px" />
						<Box
							margin-left="-2px"
							margin-top="2px"
							width="40px"
							...
							color="#2C94FF"
						>
							<Icon category="md" icon={MdInsertEmoticon} />
						</Box>
						<Button border-radius="0 0 20px 0" background="#2C94FF" font="normal 600 16px/1.5 -apple-system, system-ui, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif">
							Отправить
						</Button>
					</Box>
				</Box>
